function task1 {
    ...
    g++ -std=c++23 -Iargparse/include $1 -o task1 -lz 2>&1 | head -n 5
...
function task2 {
    ...
    g++ -std=c++23 -Iargparse/include $1 -o task2 -lz 2>&1 | head -n 5
...
function task3 {
    ...
    g++ -std=c++23 -Iargparse/include $1 -o task3 -lz 2>&1 | head -n 5
